...
public class EditSupporterController  implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        saveSupporterBtn.disableProperty().bind(name.textProperty().isEmpty().or(email.textProperty().isNull()));
